...
def run():
    ...
    parser.add_argument("-d", "--data", type=str, default="./KITTI/data/KITTI_1.data",
    ...
    # 결과 폴더 생성
    os.makedirs("./KITTI/train_result/original_1", exist_ok=True)
    os.makedirs("./KITTI/train_result/original_1/graph", exist_ok=True)
    os.makedirs("./KITTI/train_result/original_1/weight", exist_ok=True)

    result_path = './KITTI/train_result/original_1'
    ...
    for epoch in range(args.epochs):
        ...
        if epoch % args.evaluation_interval == 0:
            ...
            # 최고 성능 모델 저장
            if AP.mean() > best_MAP:
                checkpoint_path = result_path + '/weight/yolov3_train_best_fold1.pth'
        ...
        df.to_csv(result_path + '/graph/yolov3_train_fold1.csv', index=False)
        ...
        plt.savefig(result_path + '/graph/yolov3_train_loss_graph_fold1.png')
        ...
        plt.ylabel('MAP')
        plt.title('MAP_graph')
        plt.savefig(result_path + '/graph/yolov3_test_MAP_graph_fold1.png')
